...
### absorber 2
abso2 = eth.ThermalBath('abso2')

### thermal leak
leak = eth.ThermalLink(abso, cryo, 'leak')
### thermal leak
leak2 = eth.ThermalLink(abso, abso2, 'leak2')
### thermal leak
leak3 = eth.ThermalLink(abso2, cryo2, 'leak3')
...
leak3.cond = sy.symbols('G_3')
leak3.power = leak3.cond * (leak3.from_bath.temperature - leak3.to_bath.temperature)
