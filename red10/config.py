...
# EVENT PERTURBATION
#==============================================================================
energy, tau_therm, epsa, epse, t0 = sy.symbols('E, sth, epsa, epse, t0')
per = sy.zeros(len(eth.System.bath_list), 1)
per[0] = epsa * eth.event_power(energy, tau_therm, time)
per[2] = epse * eth.event_power(energy, tau_therm, time)
...
evad_sys = {load.resistivity : 2e9,
            ...
            leak.surface : 4.,
            glue.cond_alpha : 7.46e-4,
            glue.cond_expo : 3.5,
            epcoup.cond_alpha : 21.1,
            epcoup.cond_expo : 6.,
            leak.cond_alpha : 2.77e-4,
            leak.cond_expo : 4.,
